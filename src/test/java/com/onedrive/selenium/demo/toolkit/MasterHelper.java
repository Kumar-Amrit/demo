...
public abstract class MasterHelper {
	...
	public static void init() throws Exception {
		...
		if (m_browser.equals(SupportedBrowser.Chrome.toString())) {
			...
			throw new TestOneDriveException(
	...
	public void setTimeout(TimeoutType type, long time, TimeUnit unit) {
		...
		if (getWebdriver() != null) {
			...
			throw new TestOneDriveException("Webdriver is not initialized");
    ...
    public void switchToFrame(WebElement element)
    {
    	try {
    		...
    		throw new TestOneDriveException("Couldn't switch to frame of element: ");
    	}
	...
	public void isAlertExpected(boolean alertexpect) {
		try {
			...
			if (!alertexpect) {
				throw new TestOneDriveException("Unexpected Alert Found : '"
						+ alert.getText() + "'");
			}
		} catch (NoAlertPresentException e) {

			if (alertexpect) {
				throw new TestOneDriveException("Expected Alert Not Found");
			}
		}
	}
	...
	public void waitAndClick(WebElement element) {
		...
		try {
			...
			throw new TestOneDriveException("Explicit timeout after: "
					+ m_explicit_timeout);
		}
